...
export default function ForumListingPage() {
    ...
    return (
        <div className="space-y-6">
            ...
            {/* Filters */}
            <div className="bg-white rounded-2xl border border-gray-100 p-5 shadow-sm flex flex-col md:flex-row flex-wrap items-stretch md:items-center gap-4 animate-fade-in-up delay-100">
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                    <select value={categoryId} onChange={e => setCategoryId(e.target.value)}
                        className="input-premium bg-white rounded-xl text-xs font-bold uppercase tracking-wider p-2.5 cursor-pointer flex-1">
                ...
                <button onClick={doSearch} className="bg-acron-yoke-500 text-white px-6 py-2.5 rounded-xl text-sm font-black uppercase tracking-widest hover:bg-acron-thrust transition-all duration-300 shadow-sm active:scale-95 w-full md:w-auto">Search</button>
            </div>
